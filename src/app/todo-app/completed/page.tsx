...
export default function Blogs() {
  ...
  return (
    <div className="items-center justify-items-center h-full w-auto pt-8 gap-16">
      <h2 className="text-3xl font-bold py-3 w-full text-center">Completed tasks</h2>
      <div className="item">
        <form className="flex w-full" onSubmit={AddTodo}>
          <input type="text" className="p-3 w-full outline-0" style={{background: "none"}} placeholder="Add a task" onChange={(e) => setNewTask(e.target.value)}/>
